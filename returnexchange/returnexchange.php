          ...
          <div class="card" id="basket">
            <div class="card-header">
              <ul class="nav nav-pills card-header-pills align-items-center justify-content-between">
                <span style="padding-left: 3px;" id="selectedOrderNum"> Order #-----</span>
                <small style="text-decoration: underline;" id="selectedOrderTotal">0 item/s</small>
                <li class="nav-item">
            ...
            <div>
              <div class="card-footer">
                <div class="d-flex w-100 justify-content-between">
                  ...
                  <p id="basket-refund">₱0.00</p>
                </div>
                <div class="d-flex w-100 justify-content-between">
                  <small>Basket Total:</small>
                ...
                <div class="d-flex w-100 justify-content-between">
                  <small id="labelForAmt">Amount Due:</small>
                  <p id="basket-due">₱0.00</p>
                </div>
                <div class="d-grid gap-2 mt-3">
                  <button id="checkout" type="button" class="btn btn-secondary" data-bs-toggle="modal"
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-dialog modal-lg" id="receipt-modal-dialog">
        <div class="modal-content" id="receipt-modal-content">
          ...
          <div class="row text-center justify-content-between">
            ...
            <div class="col-xl-5 secondxl5">
              <small id="status">Return/Exchange</small>
            </div>
          </div>
