...
$backupDir = __DIR__ . '/backuprestore/bks/';
...
if (is_dir($backupDir)) {
  ...
  foreach ($files as $file) {
    // Check if the file name matches today's date
    if (strpos($file, $today) !== false && strpos($file, '.sql') !== false) {
      $backupExists = true;
      break;
    }
  }
} else {
  // Handle the case where the backup directory does not exist
...
<body>
  ...
  <main>
    <div class="container">
      ...
      <section
        class="section register min-vh-90 d-flex flex-column align-items-center justify-content-center py-4 position-relative">
                ...
                <div class="card-body">
                  ...
                  <form action="checkCredentials.php" method="POST">
                    ...
                    <div class="col-12 position-relative">
                      ...
                      <img src="resources/img/show.png" alt="Toggle Password" id="toggle-password"
  ...
  <footer id="footer1" class="footer1">
    ...
    <!-- Right Decoration -->
    <img src="resources/img/right_dec.png" alt="Right Decoration"
      class="right-dec position-absolute start-0 top-50 translate-middle-y">

    <!-- Left Decoration -->
    <img src="resources/img/left_dec.png" alt="Left Decoration"
      class="left-dec position-absolute end-0 top-50 translate-middle-y">
